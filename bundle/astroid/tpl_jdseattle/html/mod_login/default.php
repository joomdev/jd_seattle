   ...
   <div id="form-login-username">
      <?php if (!$params->get('usetext')) : ?>
         <div class="input-group mb-3">
            ...
            <input id="modlgn-username" type="text" name="username" class="form-control form-control-lg" tabindex="0" size="18" placeholder="<?php echo JText::_('MOD_LOGIN_VALUE_USERNAME'); ?>" />
         </div>
      <?php else : ?>
   ...
   <div id="form-login-password">
      ...
      <?php if (!$params->get('usetext')) : ?>
         ...
         <div class="input-group mb-3">
            ...
            <input id="modlgn-passwd" type="password" name="password" class="form-control form-control-lg" tabindex="0" size="18" placeholder="<?php echo JText::_('JGLOBAL_PASSWORD'); ?>" />
         </div>
      <?php else : ?>
         <label for="modlgn-passwd" class="sr-only"><?php echo JText::_('JGLOBAL_PASSWORD'); ?></label>
         <input id="modlgn-passwd" type="password" name="password" class="form-control form-control-lg" tabindex="0" size="18" placeholder="<?php echo JText::_('JGLOBAL_PASSWORD'); ?>" />
