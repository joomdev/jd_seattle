/**
 * THIS FILE IS NOT USED IN SELLACIOUS TEMPLATE
 *
 */
...
$(document).ready(function() {
	...
	if (!null) {
		$('nav ul').jarvismenu({
			accordion : true,
			speed : $.menu_speed,
			closedSign : '<em class="fa fa-plus-square"></em>',
			openedSign : '<em class="fa fa-minus-square"></em>'
		});
	} else {
