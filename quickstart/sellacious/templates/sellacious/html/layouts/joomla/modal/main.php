...
$script[] = "       $('body,html').addClass('modal-open');";
...
$script[] = "       $('body,html').removeClass('modal-open');";
...
?>
<div id="<?php echo $selector; ?>" class="modal-container fade">
	<div <?php echo ArrayHelper::toString($modalAttributes); ?>>
		<?php
		// Header
