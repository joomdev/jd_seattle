...
?><form id="acym_form" action="<?php echo acym_completeLink(acym_getVar('cmd', 'ctrl')); ?>" method="post" name="acyForm">
	<div id="acym__email__new" class="cell grid-x grid-margin-y align-center acym__content acym__selection">
		...
		<div class="cell grid-x grid-margin-x align-center">
			<div class="acym__selection__card <?php echo !acym_level(1) ? 'acym__selection__card__disabled' : ''; ?> cell medium-4 text-center" acym-data-link="<?php echo $data['campaign_scheduled_link']; ?>">
