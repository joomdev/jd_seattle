	...
	<div id="acym__subform__new" class="cell grid-x grid-margin-y align-center acym__content margin-top-2 acym__selection">
		...
		<div class="cell grid-x grid-margin-x align-center">
			<div class="acym__selection__card cell large-2 medium-4 text-center" acym-data-link="<?php echo $data['widget_link']; ?>">
				...
				<p class="acym__selection__card__description"><?php echo ACYM_CMS === 'joomla' ? acym_translation('ACYM_MODULE_SUBFORM_DESC') : acym_translation('ACYM_WIDGET_SUBFORM_DESC'); ?></p>
			</div>
            ...
            <?php } ?>
			<div class="acym__selection__card <?php echo !acym_level(2) ? 'acym__selection__card__disabled' : ''; ?> cell large-2 medium-4 text-center" acym-data-link="<?php echo $data['popup_link']; ?>">
		...
		<div class="cell grid-x grid-margin-x align-center">
			<div class="acym__selection__card <?php echo !acym_level(2) ? 'acym__selection__card__disabled' : ''; ?> cell large-2 medium-4 text-center" acym-data-link="<?php echo $data['header_link']; ?>">
			...
			<div class="acym__selection__card <?php echo !acym_level(2) ? 'acym__selection__card__disabled' : ''; ?> cell large-2 medium-4 text-center" acym-data-link="<?php echo $data['footer_link']; ?>">
