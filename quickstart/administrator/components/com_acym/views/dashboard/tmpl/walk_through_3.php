...
<div id="acym_walk-through_3" class="cell grid-x">
	...
	<div class="cell grid-x large-6 small-12 acym__walk-through-3__content">
		...
		<div class="cell grid-x acym__content cell text-center">
			...
			<p class="acym__walk-through__step cell"><?php echo acym_translation_sprintf('ACYM_STEP_X', 3, 4); ?></p>
            ...
            ?>
			<label for="acym__walk-through-3__config__charset" class="cell text-left acym__walk-through__content__label"><?php echo acym_translation('ACYM_CONFIGURATION_CHARSET'); ?></label>
            <?php
			...
			<div class="cell text-center">
				...
				<button data-task="step3" class="button acy_button_submit acym__walk-through__content__save large-shrink"><?php echo acym_translation('ACYM_SAVE_CONTINUE'); ?></button>
				<div class="large-auto"></div>
			</div>
		</div>
	</div>
