...
<div id="acym_walk-through_1" class="cell grid-x">
	...
	<div class="acym__content cell grid-x large-6 small-12 acym__walk-through-1__content text-center">
		...
		<input <?php echo $data['from_name'] == '' ? '' : 'value="'.acym_escape($data['from_name']).'"'; ?> type="text" class="input-group-field cell" name="information[from_name]" id="acym__walk-through-1__content__from-name" placeholder="<?php echo acym_translation('ACYM_COMPANY_NAME_OR_YOUR_NAME'); ?>">
		...
		<input <?php echo $data['from_email'] == '' ? '' : 'value="'.acym_escape($data['from_email']).'"'; ?> type="email" class="input-group-field cell" name="information[from_email]" id="acym__walk-through-1__content__from-email" placeholder="<?php echo acym_translation('ACYM_YOUR_EMAIL'); ?>">
		...
		<div class="acym__walk-through-1__content__reply-to cell" <?php echo empty($data['from_as_replyto']) ? '' : 'style="display:none"'; ?>>
			...
			<input <?php echo $data['replyto_name'] == '' ? '' : 'value="'.acym_escape($data['replyto_name']).'"'; ?> type="text" class="input-group-field cell" name="information[reply_to_name]" id="acym__walk-through-1__content__reply-to-name" placeholder="<?php echo acym_translation('ACYM_COMPANY_NAME_OR_YOUR_NAME'); ?>">
			...
			<input <?php echo $data['replyto_email'] == '' ? '' : 'value="'.acym_escape($data['replyto_email']).'"'; ?> type="email" class="input-group-field cell" name="information[reply_to_email]" id="acym__walk-through-1__content__reply-to-name" placeholder="<?php echo acym_translation('ACYM_YOUR_EMAIL'); ?>">
		</div>
		...
		<input <?php echo $data['bounce_email'] == '' ? '' : 'value="'.acym_escape($data['bounce_email']).'"'; ?> type="email" class="input-group-field cell" name="information[bounce_email]" id="acym__walk-through-1__content__bounce-email" placeholder="<?php echo acym_translation('ACYM_BOUNCE_MAIL'); ?>">
